  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      <div className="container mx-auto p-4">
        ...
        <form className="mb-6 p-4 bg-gray-800 rounded flex flex-wrap gap-4 items-end" onSubmit={handleAddQuestion}>
          <div>
            <label className="block text-sm font-medium text-gray-200">Company</label>
            <input className="border rounded px-2 py-1 bg-gray-900 text-white" value={form.company} onChange={e => setForm(f => ({ ...f, company: e.target.value }))} required />
          </div>
          ...
          <div>
            ...
            <select className="border rounded px-2 py-1 bg-gray-900 text-white" value={form.level} onChange={e => setForm(f => ({ ...f, level: e.target.value }))}>
              <option value="Easy">Easy</option>
              <option value="Medium">Medium</option>
              <option value="Hard">Hard</option>
            </select>
          </div>
          <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600" disabled={adding}>
          ...
          <table className="min-w-full text-white">
            <thead className="bg-gray-900 text-white">
              <tr>
                ...
                <th className="py-2 px-4">Solved by Aditya</th>
                <th className="py-2 px-4">Solved by Ananya</th>
              </tr>
            </thead>
            <tbody>
              {questions.map((q) => (
